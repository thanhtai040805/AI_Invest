...
def _run_bench_blocking(job_id: str, zoo: str, universe: str, period: str, top: int) -> None:
    ...
    from app.brain.quant.factors.bench_runner import run_bench  # local import: heavy deps
...
def register_alpha_routes(
    ...
    async def get_alpha(alpha_id: str) -> dict[str, Any]:
        ...
        from app.brain.quant.factors.registry import RegistryError, get_default_registry
    ...
    async def kick_off_bench(payload: BenchRequest) -> dict[str, Any]:
        ...
        from app.brain.tools.alpha_bench_tool import _parse_period
