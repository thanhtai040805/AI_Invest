...
from app.application.agents.core.frontmatter import parse_frontmatter as _parse_frontmatter  # shared util
...
class SkillsLoader:
    ...
    def __init__(self, skills_dir: Optional[Path] = None,
        ...
        """
        self.skills_dir = skills_dir or Path(__file__).resolve().parents[3] / "domain" / "services" / "quant" / "skills_data"
