...
from app.brain.tools.shadow_account.codegen import write_run_dir
from app.brain.tools.shadow_account.models import (
    AttributionBreakdown,
    ShadowBacktestResult,
    ShadowProfile,
)
from app.brain.tools.shadow_account.storage import runs_dir
from app.brain.tools.trade_journal_parsers import parse_file, records_to_dataframe
from app.brain.tools.trade_journal_tool import pair_trades_fifo
...
def _summarize_artifacts(
    *,
    ...
    # warning (e.g. data source flaked on one market) — downgrading to ok is
