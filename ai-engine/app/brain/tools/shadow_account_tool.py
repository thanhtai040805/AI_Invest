...
from app.brain.tools.path_utils import safe_user_path
from app.brain.shadow_account import (
...
from app.brain.shadow_account.backtester import load_cached_result
from app.brain.shadow_account.scanner import scan_today_signals
    ...
    def execute(self, **kwargs: Any) -> str:
        ...
        if result is None:
            ...
            try:
                ...
                from app.brain.shadow_account.models import AttributionBreakdown, ShadowBacktestResult
