...
export function AgentInterface() {
  ...
  useEffect(() => {
    onStatusChange((s) => {
      act().setSseStatus(s);
      if (s === "reconnecting" && prevSseStatusRef.current === "connected") toast.warning("Reconnecting...");
      else if (s === "connected" && prevSseStatusRef.current === "reconnecting") toast.success("Connected");
  ...
  }, [urlSessionId, doDisconnect, loadSessionMessages, setupSSE, forceScrollToBottom, router]);
