                ...
                layout === '3x1' && "grid grid-rows-3"
                 ...
                 {layout === '1x1' ? (
                   <>
                    ...
                    <>
                       <div className="border-r border-b border-white/5 relative"><PriceChart /><Badge className="absolute top-2 left-2 text-[8px]">CHART 1</Badge></div>
                       <div className="border-b border-white/5 relative"><PriceChart /><Badge className="absolute top-2 left-2 text-[8px]">CHART 2</Badge></div>
                       <div className="border-r border-white/5 relative"><PriceChart /><Badge className="absolute top-2 left-2 text-[8px]">CHART 3</Badge></div>
                       <div className="relative"><PriceChart /><Badge className="absolute top-2 left-2 text-[8px]">CHART 4</Badge></div>
                    </>
                 ) : (
                    <>
                       <div className="border-b border-white/5 relative"><PriceChart /><Badge className="absolute top-2 left-2 text-[8px]">TIMEFRAME 1</Badge></div>
                       <div className="border-b border-white/5 relative"><PriceChart /><Badge className="absolute top-2 left-2 text-[8px]">TIMEFRAME 2</Badge></div>
                       <div className="relative"><PriceChart /><Badge className="absolute top-2 left-2 text-[8px]">TIMEFRAME 3</Badge></div>
                    </>
                 )}
              </div>
              ...
              <div className="p-lg space-y-lg bg-white/[0.01]">
                 ...
                 <div className="grid grid-cols-2 gap-lg">
                    <FundamentalData 
                      ...
                      roe="18.5%"
                      dividend="3,500"
                      marketCap={formatCurrency(stock.marketCap || 124500000000000, 'T')}
                    />
                    <SentimentAnalysis />
                 </div>
                 <SmartInsights />
           ...
           <div className="col-span-3 flex flex-col bg-[#080808]">
              ...
              <div className="flex-1 overflow-y-auto p-md space-y-lg no-scrollbar">
                 <GlassCard className="bg-primary/5 border-primary/10 p-md">
                    ...
                    <p className="text-xs leading-relaxed opacity-80 italic">"VHM đang cho tín hiệu tích lũy tại vùng 45.x. Khối ngoại quay lại mua ròng là điểm cộng lớn cho chu kỳ tăng mới."</p>
                    <div className="mt-md flex justify-between items-end">
                       <span className="text-[9px] font-bold opacity-40">CONFIDENCE: 82%</span>
                       <Badge variant="secondary">MUA</Badge>
                    </div>
                 </GlassCard>
                 ...
                 <div className="space-y-md">
                    ...
                    {[1, 2, 3].map(i => (
                      <div key={i} className="space-y-2 group cursor-pointer">
                         <p className="text-[11px] font-bold group-hover:text-primary transition-all leading-snug">Vinhomes công bố kết quả kinh doanh quý 1 vượt kỳ vọng, doanh thu tăng 25%...</p>
                         <p className="text-[9px] opacity-40">Cafef • 2 giờ trước</p>
                      </div>
                    ))}
                 </div>
              </div>
